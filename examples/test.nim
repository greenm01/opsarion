...
proc renderUI() =
  ...
  ops.label(x, y, 200, h, "Ops widget tests", style = labelStyle)

  # Buttons
  y += pad
  if ops.button(x, y, w, h, "Start", tooltip = "I am the first!"):
    echo "button 1 pressed"

  y += pad
  if ops.button(x, y, w, h, "Stop (very long text)", tooltip = "Middle one..."):
  ...
  ops.label(300, 590, w, h, fmt"{sliderVal3:.3f}", style = labelStyle)
  ...
  ops.label(380, 590, w, h, fmt"{sliderVal4:.3f}", style = labelStyle)

  # dropDowns

  y += pad * 2
  ops.dropDown(x, y, w, h, dropDownVal1, tooltip = "Select a fruit")
  ...
  # Text fields
  y += pad * 2
  ops.textField(x, y, w * 1.0, h, textFieldVal1, tooltip = "Text field 1")

  y += pad
  ops.textField(x, y, w * 1.5, h, textFieldVal2, tooltip = "Text field 2")

  y += pad
  ops.rawTextField(x, y, w * 1.0, h, textFieldVal3, tooltip = "Text field 3")

  # Checkboxes
  y += pad * 2
  ops.checkBox(x, y, h, checkBoxVal1, tooltip = "CheckBox 1")

  ops.checkBox(x + 30, y, h, checkBoxVal2, tooltip = "CheckBox 2")
  ...
  ops.textArea(650, 300, 300, 225, textAreaVal1, tooltip = "Text area 1")
